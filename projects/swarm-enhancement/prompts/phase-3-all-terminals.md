# PHASE 3 PROMPTS - ALL TERMINALS

Copy the appropriate prompt to each terminal when transitioning to this phase.
...
2. IMPLEMENT YOUR TASK:
   - Focus on: Implement api feature
   - Write clean, documented code
   - Follow project conventions
   - Create modular, reusable components
...
3. Implement Implement api feature with tests
4. Update phase-status.json regularly
...
3. Implement Implement ui feature with tests
4. Update phase-status.json regularly
